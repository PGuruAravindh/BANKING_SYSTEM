...
<head>
    ...
    define('bankName', 'WAYNE ENTERPRISES');
...
<h1 style="background-color:black;color:white;font-size:30px" ><img style="width:75px;height:75px;" src = "./images/wayne.jpg"></img><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 1002px">
