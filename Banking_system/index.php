...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/wayne.jpg" width="50" height="50" class="d-inline-block align-top" alt="">
   <button style="background-color:#343a40;color:white;border:none;font-size:30px" ><?php echo bankName; ?></button>
  </a>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to WAYNE ENTERPRISES</h4>
