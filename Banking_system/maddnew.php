...
{
  if (!$con->query("insert into useraccounts (name,aadhaar,accountNo,accountType,city,address,email,password,balance,pin,number,branch) values ('$_POST[name]','$_POST[aadhaar]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[pin]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <th>PIN Code</th>
          <td><input type="number" name="pin" class="form-control input-sm" required></td>
        </tr>
        <tr>
