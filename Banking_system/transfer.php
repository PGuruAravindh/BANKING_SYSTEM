...
<div class="container">
  ...
  <div class="card-body">
          ...
          { $row2 = $array2->fetch_assoc();
            echo "<div class='alert alert-success w-50 mx-auto'>
                  <form method='POST'>
                    ...
                    <input type='number' name='amount'class='form-control' min='1' max='$userData[balance]' required><br></br>
					Enter PIN
					<input type='password' name='PIN' class='form-control' required>
                    <button type='submit' name='Transfer' class='btn btn-primary btn-bloc btn-sm my-1'>Transfer</button>
                  </form>
                </div>";
          }else */ if ($array3->num_rows > 0) {
    ...
    if (isset($_POST['transferSelf']))
    {
      $amount = $_POST['amount'];
	  $pin = $_POST['PIN'];
	  $result = checkPIN($userData['accountNo'], $pin);
